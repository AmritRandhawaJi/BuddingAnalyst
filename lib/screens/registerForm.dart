...
class _RegisterFormState extends State<RegisterForm> {
  ...
  @override
  void dispose() {
    FirebaseFirestore.instance.terminate();firstNameController.dispose();lastNameController.dispose();
    super.dispose();
  }
      ...
      child: Scaffold(
        ...
        child: Column(children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text("My age is",style: TextStyle(fontSize: 16),),
              Text(" $_age",style: TextStyle(fontSize: 20,color: Colors.blue),)
